...
// Do not reorder.
//
// retrogradeDays is intentionally mixed: 0 (number) means no retrograde motion;
// a string like "22.6 (20–24)" gives the average and observed range in days.
// The template guards with `!== 0` which correctly excludes the numeric sentinel.
